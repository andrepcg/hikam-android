...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
    private static final byte[] DIGITS = new byte[]{TarConstants.LF_NORMAL, TarConstants.LF_LINK, TarConstants.LF_SYMLINK, TarConstants.LF_CHR, TarConstants.LF_BLK, TarConstants.LF_DIR, TarConstants.LF_FIFO, TarConstants.LF_CONTIG, (byte) 56, (byte) 57, (byte) 97, (byte) 98, (byte) 99, (byte) 100, (byte) 101, (byte) 102};
    static final int REPLACEMENT_CHARACTER = 65533;
    @Nullable
    Segment head;
    long size;

    class C07801 extends OutputStream {
        C07801() {
        }
    ...
    class C07812 extends InputStream {
        C07812() {
        }
    ...
    public long readHexadecimalUnsignedLong() {
        ...
        do {
            ...
            while (pos < limit) {
                int digit;
                byte b = data[pos];
                if (b >= TarConstants.LF_NORMAL && b <= (byte) 57) {
                    digit = b - 48;
    ...
    public String readUtf8LineStrict(long limit) throws EOFException {
        ...
        if (scanLength < size() && getByte(scanLength - 1) == HttpConstants.CR && getByte(scanLength) == (byte) 10) {
    ...
    String readUtf8Line(long newline) throws EOFException {
        if (newline <= 0 || getByte(newline - 1) != HttpConstants.CR) {
