...
final class RealBufferedSource implements BufferedSource {
    ...
    class C07831 extends InputStream {
        C07831() {
        }
    ...
    public String readUtf8LineStrict(long limit) throws IOException {
        ...
        if (scanLength < Long.MAX_VALUE && request(scanLength) && this.buffer.getByte(scanLength - 1) == HttpConstants.CR && request(1 + scanLength) && this.buffer.getByte(scanLength) == (byte) 10) {
    ...
    public long readDecimalLong() throws IOException {
        ...
        while (request((long) (pos + 1))) {
            ...
            if ((b < TarConstants.LF_NORMAL || b > (byte) 57) && !(pos == 0 && b == (byte) 45)) {
                if (pos == 0) {
    ...
    public long readHexadecimalUnsignedLong() throws IOException {
        ...
        for (int pos = 0; request((long) (pos + 1)); pos++) {
            byte b = this.buffer.getByte((long) pos);
            if ((b < TarConstants.LF_NORMAL || b > (byte) 57) && ((b < (byte) 97 || b > (byte) 102) && (b < (byte) 65 || b > (byte) 70))) {
                if (pos == 0) {
