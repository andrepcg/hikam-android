...
public final class C0706b {
    private static String f154a = null;
    private static String f155b = null;

    public static String m139a() {
        try {
            return Build.MODEL;
        } catch (Throwable th) {
            if (!C0757w.m457a(th)) {
    ...
    public static String m140a(Context context) {
        ...
        if (AppInfo.m77a(context, "android.permission.READ_PHONE_STATE")) {
            String deviceId;
            try {
                ...
                try {
                    ...
                    C0757w.m456a("Failed to get IMEI.", new Object[0]);
                    return deviceId;
                }
            } catch (Throwable th2) {
                deviceId = null;
        ...
        C0757w.m461d("no READ_PHONE_STATE permission to get IMEI", new Object[0]);
        return null;
    }
    ...
    public static String m143b(Context context) {
        ...
        if (AppInfo.m77a(context, "android.permission.READ_PHONE_STATE")) {
            ...
            try {
                ...
                try {
                    ...
                    C0757w.m456a("Failed to get IMSI.", new Object[0]);
                    return subscriberId;
                }
            } catch (Throwable th2) {
                subscriberId = null;
        ...
        C0757w.m461d("no READ_PHONE_STATE permission to get IMSI", new Object[0]);
        return null;
    }

    public static String m145c(Context context) {
        Throwable th;
        String str = "fail";
        if (context == null) {
            return str;
        ...
        try {
            ...
            try {
                ...
                C0757w.m456a("Failed to get Android ID.", new Object[0]);
                return str;
            }
        } catch (Throwable th4) {
            th = th4;
    ...
    public static String m147d(Context context) {
        String str = "fail";
        if (context == null) {
            return str;
        }
    ...
    private static java.lang.String m166p() {
        /*
        r6 = 2;
        r1 = 0;
    ...
    L_0x004f:
        r1 = move-exception;
        r2 = com.tencent.bugly.proguard.C0757w.m457a(r1);
    ...
    L_0x0065:
        ...
        r3 = r1;
    L_0x0068:
        r4 = com.tencent.bugly.proguard.C0757w.m457a(r0);	 Catch:{ all -> 0x00ba }
    ...
    L_0x007d:
        r0 = move-exception;
        r2 = com.tencent.bugly.proguard.C0757w.m457a(r0);
        if (r2 != 0) goto L_0x0076;
    L_0x0084:
        r0.printStackTrace();
        goto L_0x0076;
    ...
    public static String m141a(boolean z) {
        String str = null;
        if (z) {
            try {
                str = C0706b.m166p();
    ...
    public static String m149e(Context context) {
    ...
    public static String m151f(Context context) {
        String a = C0761y.m489a(context, "ro.miui.ui.version.name");
        if (!C0761y.m501a(a) && !a.equals("fail")) {
            return "XiaoMi/MIUI/" + a;
        }
        a = C0761y.m489a(context, "ro.build.version.emui");
        if (!C0761y.m501a(a) && !a.equals("fail")) {
            return "HuaWei/EMOTION/" + a;
        }
        a = C0761y.m489a(context, "ro.lenovo.series");
        if (C0761y.m501a(a) || a.equals("fail")) {
            a = C0761y.m489a(context, "ro.build.nubia.rom.name");
            if (!C0761y.m501a(a) && !a.equals("fail")) {
                return "Zte/NUBIA/" + a + "_" + C0761y.m489a(context, "ro.build.nubia.rom.code");
            }
            a = C0761y.m489a(context, "ro.meizu.product.model");
            if (!C0761y.m501a(a) && !a.equals("fail")) {
                return "Meizu/FLYME/" + C0761y.m489a(context, "ro.build.display.id");
            }
            a = C0761y.m489a(context, "ro.build.version.opporom");
            if (!C0761y.m501a(a) && !a.equals("fail")) {
                return "Oppo/COLOROS/" + a;
            }
            a = C0761y.m489a(context, "ro.vivo.os.build.display.id");
            if (!C0761y.m501a(a) && !a.equals("fail")) {
                return "vivo/FUNTOUCH/" + a;
            }
            a = C0761y.m489a(context, "ro.aa.romver");
            if (!C0761y.m501a(a) && !a.equals("fail")) {
                return "htc/" + a + "/" + C0761y.m489a(context, "ro.build.description");
            }
            a = C0761y.m489a(context, "ro.lewa.version");
            if (!C0761y.m501a(a) && !a.equals("fail")) {
                return "tcl/" + a + "/" + C0761y.m489a(context, "ro.build.display.id");
            }
            a = C0761y.m489a(context, "ro.gn.gnromvernumber");
            if (!C0761y.m501a(a) && !a.equals("fail")) {
                return "amigo/" + a + "/" + C0761y.m489a(context, "ro.build.display.id");
            }
            a = C0761y.m489a(context, "ro.build.tyd.kbstyle_version");
            if (C0761y.m501a(a) || a.equals("fail")) {
                return C0761y.m489a(context, "ro.build.fingerprint") + "/" + C0761y.m489a(context, "ro.build.rom.id");
            }
            return "dido/" + a;
        }
        return "Lenovo/VIBE/" + C0761y.m489a(context, "ro.build.version.incremental");
    }

    public static String m153g(Context context) {
        return C0761y.m489a(context, "ro.board.platform");
    }

    public static boolean m155h(Context context) {
        boolean exists;
        boolean z;
        try {
        ...
        Boolean bool = null;
        ArrayList a = C0761y.m494a(context, new String[]{"/system/bin/sh", "-c", "type su"});
        if (a != null && a.size() > 0) {
            Iterator it = a.iterator();
            while (it.hasNext()) {
                Boolean valueOf;
                String str = (String) it.next();
                C0757w.m460c(str, new Object[0]);
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.lang.String m162l() {
        /*
        r0 = 0;
    ...
    L_0x0088:
        r1 = move-exception;
        com.tencent.bugly.proguard.C0757w.m457a(r1);
        goto L_0x0087;
    L_0x008d:
        r1 = move-exception;
        r1 = r0;
    ...
    public static String m157i(Context context) {
        StringBuilder stringBuilder = new StringBuilder();
        String a = C0761y.m489a(context, "ro.genymotion.version");
        if (a != null) {
        ...
        a = C0761y.m489a(context, "androVM.vbox_dpi");
        if (a != null) {
        ...
        a = C0761y.m489a(context, "qemu.sf.fake_camera");
        if (a != null) {
    ...
    public static String m159j(Context context) {
        Throwable th;
        StringBuilder stringBuilder = new StringBuilder();
        if (f154a == null) {
            f154a = C0761y.m489a(context, "ro.secure");
        }
        if (f154a != null) {
            stringBuilder.append("ro.secure");
            stringBuilder.append("|");
            stringBuilder.append(f154a);
            stringBuilder.append("\n");
        }
        if (f155b == null) {
            f155b = C0761y.m489a(context, "ro.debuggable");
        }
        if (f155b != null) {
            stringBuilder.append("ro.debuggable");
            stringBuilder.append("|");
            stringBuilder.append(f155b);
            stringBuilder.append("\n");
        }
        BufferedReader bufferedReader;
        try {
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.lang.String m163m() {
        /*
    ...
    public static String m161k(Context context) {
        StringBuilder stringBuilder = new StringBuilder();
        String a = C0761y.m489a(context, "gsm.sim.state");
        if (a != null) {
        ...
        stringBuilder.append("\n");
        a = C0761y.m489a(context, "gsm.sim.state2");
        if (a != null) {
