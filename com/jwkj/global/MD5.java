...
public class MD5 {
    ...
    private long m22F(long x, long y, long z) {
        return (x & y) | ((-1 ^ x) & z);
    }

    private long m23G(long x, long y, long z) {
        return (x & z) | ((-1 ^ z) & y);
    }

    private long m24H(long x, long y, long z) {
        return (x ^ y) ^ z;
    }

    private long m25I(long x, long y, long z) {
        return ((-1 ^ z) | x) ^ y;
    }
