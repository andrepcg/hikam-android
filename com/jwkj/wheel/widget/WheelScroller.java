...
public class WheelScroller {
    ...
    private Handler animationHandler = new C05752();
    private Context context;
    private GestureDetector gestureDetector;
    private SimpleOnGestureListener gestureListener = new C05741();
    ...
    class C05741 extends SimpleOnGestureListener {
        C05741() {
        }
