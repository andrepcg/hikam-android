...
import com.jwkj.wheel.widget.WheelScroller.ScrollingListener;
...
public class WheelView extends View {
    ...
    private static final int[] SHADOWS_COLORS = new int[]{ViewCompat.MEASURED_SIZE_MASK, ViewCompat.MEASURED_SIZE_MASK, ViewCompat.MEASURED_SIZE_MASK};
    private GradientDrawable bottomShadow;
    private Drawable centerDrawable;
    private List<OnWheelChangedListener> changingListeners = new LinkedList();
    private List<OnWheelClickedListener> clickingListeners = new LinkedList();
    private int currentItem = 0;
    private DataSetObserver dataObserver = new C05762();
    ...
    ScrollingListener scrollingListener = new C11311();
    ...
    class C05762 extends DataSetObserver {
        C05762() {
        }
    ...
    class C11311 implements ScrollingListener {
        C11311() {
        }
    ...
    private void initResourcesIfNecessary() {
        if (this.centerDrawable == null) {
            this.centerDrawable = getContext().getResources().getDrawable(C0291R.drawable.wheel_val);
        }
        ...
        setBackgroundResource(C0291R.drawable.wheel_bg);
    }
