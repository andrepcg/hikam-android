...
public class FirebaseInstanceId {
    ...
    @Nullable
    zza m14C() {
        return this.bhq.m18H().zzq("", this.bhr, WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD);
    }

    String m15D() throws IOException {
        return getToken(this.bhr, WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD);
    }
    ...
    public void deleteInstanceId() throws IOException {
        this.bhq.zzb(WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD, WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD, null);
        this.bhq.zzboq();
    }
