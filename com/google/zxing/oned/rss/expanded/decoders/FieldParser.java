...
final class FieldParser {
    ...
    static {
        r0 = new Object[24][];
        r0[0] = new Object[]{TarConstants.VERSION_POSIX, new Integer(18)};
    ...
    private static String processFixedAI(int aiSize, int fieldSize, String rawInformation) throws NotFoundException {
        ...
        return new StringBuffer().append('(').append(ai).append(')').append(rawInformation.substring(aiSize, aiSize + fieldSize)).append(parseFieldsInGeneralPurpose(rawInformation.substring(aiSize + fieldSize))).toString();
    }
    ...
    private static String processVariableAI(int aiSize, int variableFieldSize, String rawInformation) throws NotFoundException {
        ...
        return new StringBuffer().append('(').append(ai).append(')').append(rawInformation.substring(aiSize, maxSize)).append(parseFieldsInGeneralPurpose(rawInformation.substring(maxSize))).toString();
    }
}
