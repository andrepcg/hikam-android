...
public final class Version {
    ...
    static final class ECBlocks {
        ...
        ECBlocks(int x0, ECB x1, C02871 x2) {
            this(x0, x1);
        }

        ECBlocks(int x0, ECB x1, ECB x2, C02871 x3) {
            this(x0, x1, x2);
        }
