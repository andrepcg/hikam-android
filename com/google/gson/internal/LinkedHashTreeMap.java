...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C02811();
    ...
    static class C02811 implements Comparator<Comparable> {
        C02811() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C10351 extends LinkedTreeMapIterator<Entry<K, V>> {
            C10351() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C10361 extends LinkedTreeMapIterator<K> {
            C10361() {
                super();
            }
