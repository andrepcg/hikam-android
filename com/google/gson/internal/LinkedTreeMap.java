...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C02821();
    ...
    static class C02821 implements Comparator<Comparable> {
        C02821() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C10371 extends LinkedTreeMapIterator<Entry<K, V>> {
            C10371() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C10381 extends LinkedTreeMapIterator<K> {
            C10381() {
                super();
            }
