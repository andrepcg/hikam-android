...
public class zzaf extends zzaa {
    private long asg;
    private final Runnable ash = new C02441(this);
    ...
    class C02441 implements Runnable {
        ...
        class C02431 implements Runnable {
            final /* synthetic */ C02441 asl;

            C02431(C02441 c02441) {
                this.asl = c02441;
            }
        ...
        C02441(zzaf com_google_android_gms_measurement_internal_zzaf) {
            this.ask = com_google_android_gms_measurement_internal_zzaf;
        }

        @MainThread
        public void run() {
            this.ask.zzbvf().zzm(new C02431(this));
        }
    }
