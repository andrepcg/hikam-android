...
abstract class zzf {
    ...
    private final Runnable zzw = new C02471(this);

    class C02471 implements Runnable {
        final /* synthetic */ zzf aom;

        C02471(zzf com_google_android_gms_measurement_internal_zzf) {
            this.aom = com_google_android_gms_measurement_internal_zzf;
        }
