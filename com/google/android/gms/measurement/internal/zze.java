...
class zze extends zzaa {
    ...
    private class zzc extends SQLiteOpenHelper {
        ...
        private boolean zza(SQLiteDatabase sQLiteDatabase, String str) {
            ...
            try {
                ...
                query = sQLiteDatabase2.query("SQLITE_MASTER", new String[]{HttpPostBodyUtil.NAME}, "name=?", new String[]{str}, null, null, null);
                try {
    ...
    public void zza(zzh com_google_android_gms_measurement_internal_zzh, long j, boolean z) {
        ...
        try {
            ...
            contentValues.put(HttpPostBodyUtil.NAME, com_google_android_gms_measurement_internal_zzh.mName);
    ...
    public void zza(zzi com_google_android_gms_measurement_internal_zzi) {
        ...
        contentValues.put(HttpPostBodyUtil.NAME, com_google_android_gms_measurement_internal_zzi.mName);
            ...
            try {
                ...
                if (cursor2.moveToFirst()) {
                    ...
                    try {
                        ...
                        cursor = writableDatabase.query("raw_events", new String[]{"rowid", HttpPostBodyUtil.NAME, "timestamp", "data"}, "app_id=? and metadata_fingerprint=?", new String[]{string, str2}, null, null, "rowid", null);
                        if (cursor.moveToFirst()) {
                            do {
    ...
    public boolean zza(zzak com_google_android_gms_measurement_internal_zzak) {
        ...
        contentValues.put(HttpPostBodyUtil.NAME, com_google_android_gms_measurement_internal_zzak.mName);
    ...
    public List<zzak> zzly(String str) {
        ...
        try {
            Cursor query = getWritableDatabase().query("user_attributes", new String[]{HttpPostBodyUtil.NAME, "set_timestamp", Param.VALUE}, "app_id=?", new String[]{str}, null, null, "rowid", String.valueOf(zzbvi().zzbty()));
            try {
                if (query.moveToFirst()) {
                    do {
