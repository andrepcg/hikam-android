...
final class zzo extends zzn implements Callback {
    ...
    private static final class zza {
        ...
        public boolean equals(Object obj) {
            ...
            return zzab.equal(this.f11V, com_google_android_gms_common_internal_zzo_zza.f11V) && zzab.equal(this.CF, com_google_android_gms_common_internal_zzo_zza.CF);
        }

        public int hashCode() {
            return zzab.hashCode(this.f11V, this.CF);
        }

        public String toString() {
            return this.f11V == null ? this.CF.flattenToString() : this.f11V;
        }

        public Intent zzauv() {
            return this.f11V != null ? new Intent(this.f11V).setPackage(this.CE) : new Intent().setComponent(this.CF);
        }
    }
