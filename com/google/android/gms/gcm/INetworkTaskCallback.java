...
public interface INetworkTaskCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INetworkTaskCallback {
        ...
        public static INetworkTaskCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof INetworkTaskCallback)) {
                return new Proxy(obj);
            }
            return (INetworkTaskCallback) iin;
        }
