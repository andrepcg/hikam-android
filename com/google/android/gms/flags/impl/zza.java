...
public abstract class zza<T> {
    ...
    public static class zza extends zza<Boolean> {
        ...
        class C02001 implements Callable<Boolean> {
            final /* synthetic */ String UA;
            final /* synthetic */ Boolean UB;
            final /* synthetic */ SharedPreferences Uz;

            C02001(SharedPreferences sharedPreferences, String str, Boolean bool) {
        ...
        public static Boolean zza(SharedPreferences sharedPreferences, String str, Boolean bool) {
            return (Boolean) zzvb.zzb(new C02001(sharedPreferences, str, bool));
        }
    }

    public static class zzb extends zza<Integer> {

        class C02011 implements Callable<Integer> {
            final /* synthetic */ String UA;
            final /* synthetic */ Integer UC;
            final /* synthetic */ SharedPreferences Uz;

            C02011(SharedPreferences sharedPreferences, String str, Integer num) {
                this.Uz = sharedPreferences;
                this.UA = str;
                this.UC = num;
            }
        ...
        public static Integer zza(SharedPreferences sharedPreferences, String str, Integer num) {
            return (Integer) zzvb.zzb(new C02011(sharedPreferences, str, num));
        }
    }

    public static class zzc extends zza<Long> {

        class C02021 implements Callable<Long> {
            final /* synthetic */ String UA;
            final /* synthetic */ Long UD;
            final /* synthetic */ SharedPreferences Uz;

            C02021(SharedPreferences sharedPreferences, String str, Long l) {
                this.Uz = sharedPreferences;
                this.UA = str;
                this.UD = l;
            }
        ...
        public static Long zza(SharedPreferences sharedPreferences, String str, Long l) {
            return (Long) zzvb.zzb(new C02021(sharedPreferences, str, l));
        }
    }

    public static class zzd extends zza<String> {

        class C02031 implements Callable<String> {
            final /* synthetic */ String UA;
            final /* synthetic */ String UE;
            final /* synthetic */ SharedPreferences Uz;

            C02031(SharedPreferences sharedPreferences, String str, String str2) {
                this.Uz = sharedPreferences;
                this.UA = str;
                this.UE = str2;
            }
        ...
        public static String zza(SharedPreferences sharedPreferences, String str, String str2) {
            return (String) zzvb.zzb(new C02031(sharedPreferences, str, str2));
        }
    }
}
