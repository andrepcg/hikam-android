...
public class PlaceReport extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public boolean equals(Object obj) {
        ...
        return zzab.equal(this.aiY, placeReport.aiY) && zzab.equal(this.mTag, placeReport.mTag) && zzab.equal(this.f697I, placeReport.f697I);
    }
    ...
    public int hashCode() {
        return zzab.hashCode(this.aiY, this.mTag, this.f697I);
    }
    ...
    public String toString() {
        ...
        if (!EnvironmentCompat.MEDIA_UNKNOWN.equals(this.f697I)) {
            zzx.zzg("source", this.f697I);
        }
        return zzx.toString();
    }
