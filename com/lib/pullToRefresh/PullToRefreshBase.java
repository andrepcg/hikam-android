...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    class C11421 implements OnSmoothScrollFinishedListener {
        C11421() {
        }
    ...
    class C11433 implements OnSmoothScrollFinishedListener {
        C11433() {
        }
    ...
    protected void onRefreshing(boolean doScroll) {
        ...
        if (!doScroll) {
            ...
            OnSmoothScrollFinishedListener listener = new C11421();
            switch (this.mCurrentMode) {
                case PULL_FROM_END:
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0291R.styleable.PullToRefresh);
        if (a.hasValue(12)) {
            this.mMode = Mode.mapIntToValue(a.getInteger(12, 0));
        }
        if (a.hasValue(1)) {
            this.mLoadingAnimationStyle = AnimationStyle.mapIntToValue(a.getInteger(1, 0));
        }
        ...
        if (a.hasValue(13)) {
            this.mOverScrollEnabled = a.getBoolean(13, DEBUG);
        }
        if (a.hasValue(16)) {
            this.mScrollingWhileRefreshingEnabled = a.getBoolean(16, false);
        }
    ...
    private final void smoothScrollToAndBack(int y) {
        smoothScrollTo(y, 200, 0, new C11433());
    }
}
