...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
    ...
    public IndicatorLayout(Context context, Mode mode) {
        ...
        Drawable arrowD = getResources().getDrawable(C0291R.drawable.indicator_arrow);
        this.mArrowImageView.setImageDrawable(arrowD);
        int padding = getResources().getDimensionPixelSize(C0291R.dimen.indicator_internal_padding);
        this.mArrowImageView.setPadding(padding, padding, padding, padding);
        addView(this.mArrowImageView);
        switch (mode) {
            case PULL_FROM_END:
                inAnimResId = C0291R.anim.slide_in_from_bottom;
                outAnimResId = C0291R.anim.slide_out_to_bottom;
                setBackgroundResource(C0291R.drawable.indicator_bg_bottom);
                ...
                break;
            default:
                inAnimResId = C0291R.anim.slide_in_from_top;
                outAnimResId = C0291R.anim.slide_out_to_top;
                setBackgroundResource(C0291R.drawable.indicator_bg_top);
                break;
        }
