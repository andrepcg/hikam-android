...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, C0190R.styleable.NumberProgressBar, defStyleAttr, 0);
        this.mReachedBarColor = attributes.getColor(C0190R.styleable.NumberProgressBar_progress_reached_color, this.default_reached_color);
        this.mUnreachedBarColor = attributes.getColor(C0190R.styleable.NumberProgressBar_progress_unreached_color, this.default_unreached_color);
        this.mTextColor = attributes.getColor(C0190R.styleable.NumberProgressBar_progress_text_color, this.default_text_color);
        this.mTextSize = attributes.getDimension(C0190R.styleable.NumberProgressBar_progress_text_size, this.default_text_size);
        this.mReachedBarHeight = attributes.getDimension(C0190R.styleable.NumberProgressBar_progress_reached_bar_height, this.default_reached_bar_height);
        this.mUnreachedBarHeight = attributes.getDimension(C0190R.styleable.NumberProgressBar_progress_unreached_bar_height, this.default_unreached_bar_height);
        this.mOffset = attributes.getDimension(C0190R.styleable.NumberProgressBar_progress_text_offset, this.default_progress_text_offset);
        if (attributes.getInt(C0190R.styleable.NumberProgressBar_progress_text_visibility, 0) != 0) {
            this.mIfDrawText = false;
        }
        setProgress(attributes.getInt(C0190R.styleable.NumberProgressBar_progress_current, 0));
        setMax(attributes.getInt(C0190R.styleable.NumberProgressBar_progress_max, 100));
        attributes.recycle();
        initializePainters();
    }
