...
public class ListPreloader<T> implements OnScrollListener {
    ...
    class C09381 implements PreloadModelProvider<T> {
        C09381() {
        }
    ...
    class C09392 implements PreloadSizeProvider<T> {
        C09392() {
        }
    ...
    public ListPreloader(int maxPreload) {
        ...
        this.preloadModelProvider = new C09381();
        this.preloadDimensionProvider = new C09392();
