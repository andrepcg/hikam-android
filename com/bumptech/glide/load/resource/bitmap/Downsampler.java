...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    public static final Downsampler AT_LEAST = new C12661();
    public static final Downsampler AT_MOST = new C12672();
    private static final int MARK_POSITION = 5242880;
    public static final Downsampler NONE = new C12683();
    ...
    static class C12661 extends Downsampler {
        C12661() {
        }
    ...
    static class C12672 extends Downsampler {
        C12672() {
        }
    ...
    static class C12683 extends Downsampler {
        C12683() {
        }
