...
public class MD5 {
    ...
    private long m26F(long x, long y, long z) {
        return (x & y) | ((-1 ^ x) & z);
    }

    private long m27G(long x, long y, long z) {
        return (x & z) | ((-1 ^ z) & y);
    }

    private long m28H(long x, long y, long z) {
        return (x ^ y) ^ z;
    }

    private long m29I(long x, long y, long z) {
        return ((-1 ^ z) | x) ^ y;
    }
