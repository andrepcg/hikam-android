...
public abstract class EventListener {
    public static final EventListener NONE = new C11571();

    public interface Factory {
        EventListener create(Call call);
    }

    class C11571 extends EventListener {
        C11571() {
        }
    }

    class C11582 implements Factory {
        final /* synthetic */ EventListener val$listener;

        C11582(EventListener eventListener) {
