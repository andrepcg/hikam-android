...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener listener, Random random) {
        if (HttpGet.METHOD_NAME.equals(request.method())) {
            ...
            this.writerRunnable = new C07791();
            return;
        }
    ...
    public void connect(OkHttpClient client) {
        ...
        final Request request = this.originalRequest.newBuilder().header("Upgrade", "websocket").header("Connection", "Upgrade").header(Names.SEC_WEBSOCKET_KEY, this.key).header(Names.SEC_WEBSOCKET_VERSION, "13").build();
