...
public class TransportMediator extends TransportController {
    ...
    class C00622 implements Callback {
        C00622() {
        }
    ...
    class C09021 implements TransportMediatorCallback {
        C09021() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C09021();
        this.mKeyEventCallback = new C00622();
