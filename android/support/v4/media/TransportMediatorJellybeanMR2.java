...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00664();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C00675();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00653();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C00686();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C00631();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00642();

    class C00631 implements OnWindowAttachListener {
        C00631() {
        }
    ...
    class C00642 implements OnWindowFocusChangeListener {
        C00642() {
        }
    ...
    class C00653 extends BroadcastReceiver {
        C00653() {
        }
    ...
    class C00664 implements OnAudioFocusChangeListener {
        C00664() {
        }
    ...
    class C00675 implements OnGetPlaybackPositionListener {
        C00675() {
        }
    ...
    class C00686 implements OnPlaybackPositionUpdateListener {
        C00686() {
        }
