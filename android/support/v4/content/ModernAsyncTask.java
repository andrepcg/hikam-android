...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00361();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C08952();

    static class C00361 implements ThreadFactory {
    ...
    class C08952 extends WorkerRunnable<Params, Result> {
        C08952() {
        }
