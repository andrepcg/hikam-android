...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C09251());
        boolean isOpen;

        static class C09251 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C09251() {
            }
