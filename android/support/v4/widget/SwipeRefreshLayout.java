...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        float tensionPercent = ((float) (((double) (tensionSlingshotPercent / ImageBrowser.SCALE_MAX)) - Math.pow((double) (tensionSlingshotPercent / ImageBrowser.SCALE_MAX), 2.0d))) * DECELERATE_INTERPOLATION_FACTOR;
