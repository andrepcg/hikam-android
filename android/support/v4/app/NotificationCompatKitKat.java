...
class NotificationCompatKitKat {
    ...
    public static class Builder implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions {
        private android.app.Notification.Builder f527b;
        ...
        public void addAction(Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f527b, action));
        }
        ...
        public Notification build() {
            ...
            this.f527b.setExtras(this.mExtras);
            Notification notification = this.f527b.build();
