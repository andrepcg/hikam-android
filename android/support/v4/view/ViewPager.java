...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00921();
    ...
    private static final Interpolator sInterpolator = new C00932();
    ...
    private final Runnable mEndScrollRunnable = new C00943();
    ...
    static class C00921 implements Comparator<ItemInfo> {
        C00921() {
        }
    ...
    static class C00932 implements Interpolator {
        C00932() {
        }
    ...
    class C09144 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C09151());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C09151 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C09151() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C09144());
    }
