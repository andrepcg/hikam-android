...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C01391 extends DataSetObserver {
        C01391() {
        }
    ...
    class C01402 implements OnGlobalLayoutListener {
        C01402() {
        }
    ...
    class C01414 extends DataSetObserver {
        C01414() {
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetOberver = new C01391();
        this.mOnGlobalLayoutListener = new C01402();
        ...
        this.mAdapter.registerDataSetObserver(new C01414());
