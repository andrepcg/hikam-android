...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0131R.attr.actionBarSize, 16842841};
    ...
    class C01374 implements Runnable {
        C01374() {
        }
    ...
    class C12621 extends ViewPropertyAnimatorListenerAdapter {
        C12621() {
        }
    ...
    class C12632 extends ViewPropertyAnimatorListenerAdapter {
        C12632() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C12621();
        this.mBottomAnimatorListener = new C12632();
        this.mRemoveActionBarHideOffset = new C01363();
        this.mAddActionBarHideOffset = new C01374();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            ...
            this.mActionBarBottom = (ActionBarContainer) findViewById(C0131R.id.split_action_bar);
        }
    }
