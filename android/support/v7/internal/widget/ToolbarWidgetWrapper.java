...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    class C12642 extends ViewPropertyAnimatorListenerAdapter {
    ...
    class C12653 extends ViewPropertyAnimatorListenerAdapter {
        C12653() {
        }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription, int defaultNavigationIcon) {
        ...
        this.mToolbar.setNavigationOnClickListener(new C01501());
    }
    ...
    private void ensureSpinner() {
        if (this.mSpinner == null) {
            this.mSpinner = new SpinnerCompat(getContext(), null, C0131R.attr.actionDropDownStyle);
    ...
    public void animateToVisibility(int visibility) {
        if (visibility == 8) {
            ViewCompat.animate(this.mToolbar).alpha(0.0f).setListener(new C12642());
        } else if (visibility == 0) {
            ViewCompat.animate(this.mToolbar).alpha(1.0f).setListener(new C12653());
        }
    }
