...
public class ActionBarContextView extends AbsActionBarView implements ViewPropertyAnimatorListener {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mSplitBackground = a.getDrawable(C0131R.styleable.ActionMode_backgroundSplit);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        this.mClose.findViewById(C0131R.id.action_mode_close_button).setOnClickListener(new OnClickListener() {
