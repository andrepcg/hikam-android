...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C12591();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C12602();
    ...
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C09293();

    class C09293 implements ViewPropertyAnimatorUpdateListener {
        C09293() {
        }
    ...
    class C12591 extends ViewPropertyAnimatorListenerAdapter {
        C12591() {
        }
    ...
    class C12602 extends ViewPropertyAnimatorListenerAdapter {
        C12602() {
        }
    ...
    private void init(View decor) {
        ...
        this.mSplitView = (ActionBarContainer) decor.findViewById(C0131R.id.split_action_bar);
        ...
        if (a.getBoolean(C0131R.styleable.ActionBar_hideOnContentScroll, false)) {
