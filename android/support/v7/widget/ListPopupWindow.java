...
public class ListPopupWindow {
    ...
    class C01553 implements OnItemSelectedListener {
        C01553() {
        }
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0131R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0131R.styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C01542();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C01553());
