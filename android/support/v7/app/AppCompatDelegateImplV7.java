...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    private final Runnable mInvalidatePanelMenuRunnable = new C01271();
    ...
    class C01284 implements Runnable {
        C01284() {
        }
    ...
    class C09262 implements OnApplyWindowInsetsListener {
        C09262() {
        }
    ...
    class C09273 implements OnFitSystemWindowsListener {
        C09273() {
        }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    this.mSubDecor = (ViewGroup) inflater.inflate(C0131R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    this.mSubDecor = (ViewGroup) inflater.inflate(C0131R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(this.mSubDecor, new C09262());
                } else {
                    ((FitWindowsViewGroup) this.mSubDecor).setOnFitSystemWindowsListener(new C09273());
                }
            } else if (this.mIsFloating) {
                this.mSubDecor = (ViewGroup) inflater.inflate(C0131R.layout.abc_dialog_title_material, null);
                ...
                this.mSubDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0131R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) this.mSubDecor.findViewById(C0131R.id.decor_content_parent);
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) this.mSubDecor.findViewById(C0131R.id.title);
            }
            ...
            ContentFrameLayout abcContent = (ContentFrameLayout) this.mSubDecor.findViewById(C0131R.id.action_bar_activity_content);
    ...
    private void applyFixedSizeWindow(ContentFrameLayout contentFrameLayout) {
        ...
        a.getValue(C0131R.styleable.Theme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        a.getValue(C0131R.styleable.Theme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (a.hasValue(C0131R.styleable.Theme_windowFixedWidthMajor)) {
            a.getValue(C0131R.styleable.Theme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (a.hasValue(C0131R.styleable.Theme_windowFixedWidthMinor)) {
            a.getValue(C0131R.styleable.Theme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (a.hasValue(C0131R.styleable.Theme_windowFixedHeightMajor)) {
            a.getValue(C0131R.styleable.Theme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (a.hasValue(C0131R.styleable.Theme_windowFixedHeightMinor)) {
            a.getValue(C0131R.styleable.Theme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        a.recycle();
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mShowActionModePopup = new C01284();
                } else {
