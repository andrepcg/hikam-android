...
class AlertController {
    ...
    private final OnClickListener mButtonHandler = new C01211();
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                ListAdapter c01232 = new CursorAdapter(this.mContext, this.mCursor, false) {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0131R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    private void setupView() {
        View customView;
        setupContent((ViewGroup) this.mWindow.findViewById(C0131R.id.contentPanel));
        boolean hasButtons = setupButtons();
        ViewGroup topPanel = (ViewGroup) this.mWindow.findViewById(C0131R.id.topPanel);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mContext, null, C0131R.styleable.AlertDialog, C0131R.attr.alertDialogStyle, 0);
        boolean hasTitle = setupTitle(topPanel);
        View buttonPanel = this.mWindow.findViewById(C0131R.id.buttonPanel);
        if (!hasButtons) {
            buttonPanel.setVisibility(8);
            View spacer = this.mWindow.findViewById(C0131R.id.textSpacerNoButtons);
            if (spacer != null) {
                spacer.setVisibility(0);
            }
        }
        FrameLayout customPanel = (FrameLayout) this.mWindow.findViewById(C0131R.id.customPanel);
        if (this.mView != null) {
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (ScrollView) this.mWindow.findViewById(C0131R.id.scrollView);
