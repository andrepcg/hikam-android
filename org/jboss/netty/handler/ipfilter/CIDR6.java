...
public class CIDR6 extends CIDR {
    ...
    public int compareTo(CIDR arg) {
        ...
        if (arg instanceof CIDR4) {
            res = ipv6AddressToBigInteger(arg.baseAddress).compareTo(this.addressBigInt);
            if (res != 0) {
                return res;
            }
        ...
        res = o.addressBigInt.compareTo(this.addressBigInt);
        if (res != 0) {
            return res;
        }
    ...
    public boolean contains(InetAddress inetAddress) {
        if (inetAddress == null) {
            ...
            if (search.compareTo(this.addressBigInt) < 0 || search.compareTo(this.addressEndBigInt) > 0) {
                return false;
            }
            return true;
        }
