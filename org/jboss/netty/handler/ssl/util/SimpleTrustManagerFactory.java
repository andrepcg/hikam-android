...
public abstract class SimpleTrustManagerFactory extends TrustManagerFactory {
    private static final ThreadLocal<SimpleTrustManagerFactorySpi> CURRENT_SPI = new C08692();
    private static final Provider PROVIDER = new Provider("", 0.0d, "") {
        private static final long serialVersionUID = -2680540247105807895L;
    };

    static class C08692 extends ThreadLocal<SimpleTrustManagerFactorySpi> {
        C08692() {
        }
