...
public abstract class HttpHeaders implements Iterable<Entry<String, String>> {
    public static final HttpHeaders EMPTY_HEADERS = new C12301();
    ...
    static class C12301 extends HttpHeaders {
        C12301() {
        }
    ...
    public static void setKeepAlive(HttpMessage message, boolean keepAlive) {
        ...
        if (message.getProtocolVersion().isKeepAliveDefault()) {
            if (keepAlive) {
                ...
                h.set("Connection", (Object) "close");
            }
        } else if (keepAlive) {
            h.set("Connection", (Object) "keep-alive");
        } else {
            h.remove("Connection");
        }
    }
    ...
    public static void setContentLength(HttpMessage message, long length) {
        message.headers().set("Content-Length", Long.valueOf(length));
    }
    ...
    public static void setHost(HttpMessage message, String value) {
        message.headers().set("Host", (Object) value);
    }
    ...
    public static boolean is100ContinueExpected(HttpMessage message) {
        ...
        return message.headers().contains("Expect", "100-continue", true);
    }
