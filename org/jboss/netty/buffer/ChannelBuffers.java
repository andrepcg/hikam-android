...
public final class ChannelBuffers {
    ...
    public static int compare(ChannelBuffer bufferA, ChannelBuffer bufferB) {
        ...
        for (i = byteCount; i > 0; i--) {
            ...
            short vb2 = bufferB.getUnsignedByte(bIndex);
            if (va2 > vb2) {
                return 1;
            }
            if (va2 < vb2) {
    ...
    public static int swapMedium(int value) {
        return (((value << 16) & 16711680) | (MotionEventCompat.ACTION_POINTER_INDEX_MASK & value)) | ((value >>> 16) & 255);
    }

    public static int swapInt(int value) {
        return (swapShort((short) value) << 16) | (swapShort((short) (value >>> 16)) & SupportMenu.USER_MASK);
    }
