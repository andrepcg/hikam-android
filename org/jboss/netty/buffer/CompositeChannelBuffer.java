...
public class CompositeChannelBuffer extends AbstractChannelBuffer {
    ...
    public int getUnsignedMedium(int index) {
        ...
        if (order() == ByteOrder.BIG_ENDIAN) {
            return ((getShort(index) & SupportMenu.USER_MASK) << 8) | (getByte(index + 2) & 255);
        }
        return (getShort(index) & SupportMenu.USER_MASK) | ((getByte(index + 2) & 255) << 16);
    }
    ...
    public int getInt(int index) {
        ...
        if (order() == ByteOrder.BIG_ENDIAN) {
            return ((getShort(index) & SupportMenu.USER_MASK) << 16) | (getShort(index + 2) & SupportMenu.USER_MASK);
        }
        return (getShort(index) & SupportMenu.USER_MASK) | ((getShort(index + 2) & SupportMenu.USER_MASK) << 16);
    }
    ...
    public ChannelBuffer slice(int index, int length) {
        ...
        switch (components.size()) {
            ...
            default:
                return new CompositeChannelBuffer(order(), components, this.gathering);
        }
    }
